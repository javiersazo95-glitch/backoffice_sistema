...
export default function ResolvedCaseTimelineModal({ isOpen, onClose, item }: ResolvedCaseTimelineModalProps) {
  ...
  const resolucionDate = item.createdAt ? formatDateTime(item.createdAt) : undefined;

  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Historial del caso" wide>
          ...
          <div className="resolved-timeline">
            ...
            <TimelineStage label="Apertura" variant="esperando-vendedor" icon="alert" date={aperturaDate}>
              <div className="resolved-timeline-fields">
                <div className="resolved-timeline-field">
                  ...
                  <span className="resolved-timeline-field-value">{item.reason || 'No especificado'}</span>
                </div>
                <div className="resolved-timeline-field">
                ...
                <div className="resolved-timeline-field">
                  ...
                  <span className="resolved-timeline-field-value">{item.buyer || 'No informado'}</span>
                </div>
                <div className="resolved-timeline-field">
                ...
                {detail?.owner && (
                  <div className="resolved-timeline-field">
                    ...
                    <span className="resolved-timeline-field-value">{detail.owner}</span>
                  </div>
                )}
              </div>
            </TimelineStage>
            ...
            <TimelineStage label="En mediación" variant="en-mediacion" icon="scale" date={mediacionDate}>
              <div className="resolved-timeline-fields">
                <div className="resolved-timeline-field">
                  <span className="resolved-timeline-field-label">Responsable</span>
                  <span className="resolved-timeline-field-value">{detail?.owner || 'Mediador'}</span>
                </div>
              </div>
              {allDocs.length > 0 && (
            ...
            {/* Etapa 3: Resuelta */}
            <TimelineStage label="Resuelta" variant="resuelta" icon="check" date={resolucionDate} isLast>
              <div className="resolved-timeline-fields">
                <div className="resolved-timeline-field">
                  <span className="resolved-timeline-field-label">Motivo de resolución</span>
                  <span className="resolved-timeline-field-value">{item.resolutionReason || 'No especificado'}</span>
                </div>
                <div className="resolved-timeline-field">
                  <span className="resolved-timeline-field-label">Resuelto por</span>
                  <span className="resolved-timeline-field-value">{item.resolvedBy || 'No informado'}</span>
                </div>
              </div>
              {item.documentUrl && (
                <div className="resolved-timeline-docs">
                  <span className="resolved-timeline-docs-label">Documento de resolución</span>
                  <div className="resolved-timeline-docs-list">
                    <DocLink name={item.documentName || 'Documento de cierre'} url={item.documentUrl} />
                  </div>
                </div>
              )}
            </TimelineStage>
